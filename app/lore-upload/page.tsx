...
export default function LoreUploadPage() {
  ...
  async function handleWorldChange(e: ChangeEvent<HTMLSelectElement>) {
    ...
    if (value === "create_new") {
      // Abre modal para criar um novo mundo com nome, descrição e flag de episódios
      ...
      {showNewWorldModal && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70">
          <div className="w-full max-w-md max-h-[90vh] overflow-auto border border-neutral-800 rounded-lg p-4 bg-neutral-950/95 space-y-3">
            <div className="flex items-center justify-between">
              <div className="text-[11px] text-neutral-400">Novo Mundo</div>
              <button
                type="button"
            ...
            <div className="flex justify-end gap-2 pt-1">
              <button
                type="button"
                onClick={handleCancelWorldModal}
                className="px-3 py-1.5 rounded border border-neutral-700 text-[11px] text-neutral-300 hover:bg-neutral-800/60"
              >
                Cancelar
              </button>
              <button
